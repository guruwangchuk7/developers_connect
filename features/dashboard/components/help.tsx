  ...
  const guides = [
    {
      ...
      description: "Your central hub for technical synchronization. Switch between tabs to see different types of network activity.",
      icon: LayoutGrid,
      steps: [
    ...
    },
    {
      ...
      description: "Contributing high-signal technical content is how you build your reputation in the network.",
      icon: Share2,
      steps: [
    ...
    },
    {
      ...
      icon: Search,
      steps: [
        { label: "Skill Mapping", detail: "Search by specific frameworks, languages, or architectural focus." },
        { label: "Connection Sync", detail: "Request a connection to start collaborating on projects." },
    ...
    <div className="space-y-12 animate-in fade-in duration-700 max-w-[900px]">
      ...
      <section className="space-y-4">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-[20px] font-semibold tracking-tight">Platform Synchronization Guide</h2>
        </div>
        <p className="text-[15px] text-muted-foreground leading-relaxed max-w-[700px]">
          The Bhutanese Developer Network (BDN) is a high-signal environment designed for professional technical collaboration. 
          Use this guide to optimize your workspace and maximize your impact within the ecosystem.
        </p>
      </section>
      ...
      <section className="mt-8 p-8 border border-border/10 bg-secondary/5 rounded-[24px] space-y-6">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-[16px] font-bold tracking-tight uppercase">Network Protocol</h3>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
          <div className="space-y-2">
            <p className="text-[11px] font-black uppercase tracking-[0.2em] text-primary/60">High Signal</p>
            <p className="text-[13px] text-muted-foreground/70 leading-snug">Focus on technical depth and architectural clarity over generic updates.</p>
          </div>
          <div className="space-y-2">
            <p className="text-[11px] font-black uppercase tracking-[0.2em] text-primary/60">Collaborative</p>
            <p className="text-[13px] text-muted-foreground/70 leading-snug">Prioritize helping peers solve blockers to strengthen the national tech stack.</p>
          </div>
          <div className="space-y-2">
      ...
      <section className="flex flex-col items-center justify-center py-12 space-y-4 text-center">
        ...
        <p className="text-[13px] font-medium text-muted-foreground">Ready to begin your synchronization?</p>
        <button 
